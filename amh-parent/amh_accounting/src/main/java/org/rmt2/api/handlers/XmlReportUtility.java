...
public class XmlReportUtility extends RMT2Base {
    ...
    // */
    // public XmlReportUtility(String xslPath, String xml, String resultsPath)
    // throws SystemException {
    //
    // }
    ...
    public void init() throws SystemException {
        ...
        // this.getSession().getAttribute(RMT2ServletConst.SESSION_BEAN);
        ...
        // Get image directory
        this.imageDirPath += "..\\images\\"; // might need to reference
                                             // "images\\"
        ...
        // this.reportName += this.xslPath + "/" + this.xslFileName;

        // // Set the polling service that will trigger the action handler to
        // generate the report.
        // // This could be overidden.
        // this.pollService = "unsecureRequestProcessor/" + (String)
        // parsedRequest.get(0) + "." + (String) parsedRequest.get(1);
    ...
    // * prooperly casting.
    // * <p>
    // * This method invokes receiveClientData to receive user input. The
    // methods
    ...
    // * developer is responsible for passing any required data to the client
    // via
    ...
    // this.doPostCustomInitialization(this.query,
    // RMT2ServletConst.SEARCH_MODE_NEW);
    ...
    // this.msg =
    // "User must supply a action for the polling JSP page in order to run selected report";
    ...
    // this.getSession().getAttribute(RMT2ServletConst.REPORT_BEAN);
    ...
    //
    // /**
    // * Builds the URL for the polling service that displays the
    // "Wait Please..."
    // * JSP page.
    // *
    ...
    // * @throws ActionHandlerException
    // */
    // protected String fetchHostCompany(Object dao) throws
    // ActionHandlerException {
    // if (dao == null) {
    // this.msg =
    // "Failed to obtain host company data since DAO parameter is invalid";
    // logger.log(Level.ERROR, this.msg);
    // throw new ActionHandlerException(this.msg);
    // }
    ...
    // else {
    // this.msg =
    // "Failed to obtain host company data since DAO parameter is not an instance of HostCompanyManager";
    // logger.log(Level.ERROR, this.msg);
    // throw new ActionHandlerException(this.msg);
    // }
    // }
    ...
    //
    // /**
    // * Sets the service that the polling service will use to trigger the
    // clients
    // * command.
    // * <p>
    ...
    //
    // /**
    // * Prepare the environment for running the report. This method is call
    // prior
    // * to the actual generation of the report from the run() method. Listed
    // are
    ...
    // * {@link XmlReportUtility#setupReportLayout()}.</li>
    ...
    // * {@link XmlReportUtility#createWellFormedData(String)}.</li>
    ...
    // * @throws ActionHandlerException
    // */
    // protected abstract String initializeReport() throws
    // ActionHandlerException;
    //
    // /**

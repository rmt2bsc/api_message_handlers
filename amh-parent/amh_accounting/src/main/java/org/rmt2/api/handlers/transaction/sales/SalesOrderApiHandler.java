...
/**
 * Handles and routes Sales Order Transaction messages to the Accounting API.
 * 
 * @author rterrell
 *
 */
public class SalesOrderApiHandler extends CommonSalesOrderApiHandler {
    ...
    protected MessageHandlerResults create(AccountingTransactionRequest req) {
        ...
        try {
            ...
            rs.setMessage(SalesOrderApiHandler.MSG_CREATE_FAILURE);
    ...
    // this.command, e);
    // rs.setReturnCode(MessagingConstants.RETURN_CODE_FAILURE);
    // rs.setMessage(SalesOrderApiHandler.MSG_FAILURE);
    // rs.setExtMessage(e.getMessage());
    // } finally {
    // this.api.close();
    // }
    ...
    protected void validateRequest(AccountingTransactionRequest req) throws InvalidDataException {
        ...
        try {
            ...
            throw new InvalidRequestException(MSG_MISSING_PROFILE_DATA);
        }
    ...
    // } catch (VerifyException e) {
    // throw new
    // InvalidRequestException(SalesOrderApiHandler.MSG_MISSING_CREDITOR_PROFILE_DATA,
    // e);
    // }
    // }
    // }

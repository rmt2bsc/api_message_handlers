 ...
 *
 */
public class CommonSalesOrderApiHandler extends
        AbstractJaxbMessageHandler<AccountingTransactionRequest, AccountingTransactionResponse, List<SalesOrderType>> {

    private static final Logger logger = Logger.getLogger(CommonSalesOrderApiHandler.class);
     ...
     */
    public CommonSalesOrderApiHandler() {
        super();
        ...
        logger.info(CommonSalesOrderApiHandler.class.getName() + " was instantiated successfully");
    }
        ...
        try {
            ...
            switch (this.targetLevel) {
                ...
                case TARGET_LEVEL_FULL:
                    ...
                    if (dtoList == null) {
                        rs.setMessage(CommonSalesOrderApiHandler.MSG_DATA_NOT_FOUND);
                        rs.setRecordCount(0);
                    }
                    else {
                        queryDtoResults = this.buildJaxbTransaction(dtoList);
                        rs.setMessage(CommonSalesOrderApiHandler.MSG_DATA_FOUND);

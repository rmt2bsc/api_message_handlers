...
public class QueryDisbursementApiHandler extends XactApiHandler {
    ...
    // XactType reqXact =
    // req.getProfile().getTransactions().getTransaction().get(0);
    ...
    // rs.setReturnStatus(MessagingConstants.RETURN_STATUS_SUCCESS);
    // XactDto xactDto =
    // TransactionJaxbDtoFactory.createXactDtoInstance(reqXact);
    ...
    // XactType XactResults =
    // TransactionJaxbDtoFactory.createXactJaxbInstance(xactDto, 0,
    // itemsDtoList);
    // tranRresults.add(XactResults);
    // String msg = RMT2String.replace(MSG_CREATE_SUCCESS,
    // String.valueOf(XactResults.getXactId()), "%s");
    // rs.setMessage(msg);
    // rs.setRecordCount(1);
    //
    // rs.setReturnCode(MessagingConstants.RETURN_CODE_SUCCESS);
    ...
    // * @return an instance of {@link MessageHandlerResults}
    // */
    // protected MessageHandlerResults
    // createForCreditor(AccountingTransactionRequest req) {
    // MessageHandlerResults results = new MessageHandlerResults();
    // MessageHandlerCommonReplyStatus rs = new
    // MessageHandlerCommonReplyStatus();
    // XactType reqXact =
    ...
    // .createXactItemDtoInstance(reqXact.getLineitems().getLineitem());
    // CreditorDto credDto =
    // TransactionJaxbDtoFactory.createCreditorDtoInstance(reqXact);
    //
    // int newXactId = this.api.updateTrans(xactDto, itemsDtoList,
    // credDto.getCreditorId());
    // xactDto.setXactId(newXactId);
    // XactType XactResults =
    // TransactionJaxbDtoFactory.createXactJaxbInstance(xactDto, 0,
    // itemsDtoList);
    ...
    protected void validateRequest(AccountingTransactionRequest req) throws InvalidDataException {
        ...
        // switch (this.command) {
        // case ApiTransactionCodes.ACCOUNTING_CASHDISBURSE_GET:
        // // Must contain flag that indicates what level of the transaction
        // object to populate with data
        // this.validateSearchRequest(req);
        // break;
        //
    ...
    // if
    // (ApiTransactionCodes.ACCOUNTING_CASHDISBURSE_CREDITOR_CREATE.equalsIgnoreCase(this.command))
    // {
    // try {
    ...
    // throw new
    // InvalidRequestException(QueryDisbursementApiHandler.MSG_MISSING_CREDITOR_PROFILE_DATA,
    // e);
    // }
    // }
    // }

...
/**
 * Tests the updating, invoicing, and cash receipt of a sales order as one
...
public class SalesOrderUpdateAndInvoiceAndCashReceiptMessageHandlerTest extends BaseAccountingMessageHandlerTest {
     ...
     * 
     */
    public SalesOrderUpdateAndInvoiceAndCashReceiptMessageHandlerTest() {
        return;
    }
    ...
    public void testSuccess_update() {
        ...
        try {
            results = handler.processMessage(ApiTransactionCodes.ACCOUNTING_SALESORDER_INVOICE_PAYMENT_UPDATE, request);
        ...
        Assert.assertEquals(SalesOrderHandlerConst.MSG_INVOICED_PAYMENT_SUCCESS, actualRepsonse.getReplyStatus().getMessage());
    ...
    public void test_API_Error() {
        ...
        Assert.assertEquals(SalesOrderHandlerConst.MSG_INVOICE_PAYMENT_FAILURE, actualRepsonse.getReplyStatus().getMessage());

...
public class CashReceiptsQueryMessageHandlerTest extends BaseAccountingMessageHandlerTest {
    ...
    public void testSuccess_Fetch_BasicCriteria_Header() {
        ...
        List<XactDto> mockListData = CashReceiptsMockData.createMockSingleTransactions();
    ...
    public void testSuccess_Fetch_BasicCriteria_Full() {
        ...
        List<XactDto> mockListData = CashReceiptsMockData.createMockSingleTransactions();
        List<XactTypeItemActivityDto> mockItemListData = CashReceiptsMockData.createMockXactItems();

...
public class SalesOrderQueryMessageHandlerTest extends BaseAccountingMessageHandlerTest {
    ...
    public void testSuccess_Query_Full() {
        ...
        List<SalesOrderDto> mockSalesOrderDtoList = SalesOrderMockData.createMockSalesOrders();
        ...
        try {
            when(this.mockApi.getSalesOrder(isA(SalesOrderDto.class))).thenReturn(mockSalesOrderDtoList);
        } catch (Exception e) {

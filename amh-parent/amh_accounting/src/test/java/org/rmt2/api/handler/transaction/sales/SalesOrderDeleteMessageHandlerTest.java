...
/**
 * Tests the sales order delete API message handler
 * 
 * @author roy.terrell
 *
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ AbstractDaoClientImpl.class, Rmt2OrmClientFactory.class, DeleteSalesOrderApiHandler.class,
        SalesApiFactory.class,
        SystemConfigurator.class })
public class SalesOrderDeleteMessageHandlerTest extends BaseAccountingMessageHandlerTest {
     ...
     * 
     */
    public SalesOrderDeleteMessageHandlerTest() {
        return;
    }
    ...
    public void testSuccess_Delete() {
        ...
        DeleteSalesOrderApiHandler handler = new DeleteSalesOrderApiHandler();
        try {
            results = handler.processMessage(ApiTransactionCodes.ACCOUNTING_SALESORDER_DELETE, request);
        ...
        String expectedMsg = RMT2String.replace(SalesOrderHandlerConst.MSG_DELETE_SUCCESS,
    ...
    public void test_API_Error() {
        ...
        try {
            when(this.mockApi.deleteSalesOrder(isA(Integer.class))).thenThrow(
        ...
        Assert.assertEquals(SalesOrderHandlerConst.MSG_DELETE_FAILURE, actualRepsonse.getReplyStatus().getMessage());

...
/**
 * Tests the customer's sales order query API message handler
 * 
 * @author roy.terrell
 *
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ AbstractDaoClientImpl.class, Rmt2OrmClientFactory.class, QueryCustomerSalesOrderApiHandler.class,
        SalesApiFactory.class, SubsidiaryApiFactory.class, ContactsApiFactory.class, XactApiFactory.class,
        SystemConfigurator.class })
public class SalesOrderCustomerQueryMessageHandlerTest extends BaseAccountingMessageHandlerTest {
     ...
     * 
     */
    public SalesOrderCustomerQueryMessageHandlerTest() {
        return;
    }
    ...
    /**
     * Test the query method successfully
     */
    @Test
    public void testSuccess_Query() {
        ...
        QueryCustomerSalesOrderApiHandler handler = new QueryCustomerSalesOrderApiHandler();
        try {
            results = handler.processMessage(ApiTransactionCodes.ACCOUNTING_SALESORDER_GET_CUSTOMER_SPECIFIC, request);
        ...
        String expectedMsg = EXPECTED_REC_TOTAL + " customer sales order(s) were found";
    ...
    public void test_API_Error() {
        String request =
                RMT2File.getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequest.xml");
    ...
    public void testValidation_Missing_Criteria() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustoemrQueryMissingGeneralCriteriaRequest.xml");
    ...
    public void testValidation_Missing_Sales_Order_Criteria() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingSalesCriteria.xml");
    ...
    public void testValidation_Missing_Customer_Criteria1() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingCustomerCriteria.xml");
    ...
    public void testValidation_Missing_Customer_Criteria2() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingCustomerCriteria2.xml");
    ...
    public void testValidation_Missing_Transaction_Criteria() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingTransactionCriteria.xml");
    ...
    public void testValidation_Missing_Transaction_Criteria2() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingTransactionCriteria2.xml");
    ...
    public void testValidation_Missing_SalesOrderId_Criteria() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingSalesOrderId.xml");
    ...
    public void testValidation_Missing_CustomerId_Criteria() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingCustomerId.xml");
    ...
    public void testValidation_Missing_XactId_Criteria() {
        String request = RMT2File
                .getFileContentsAsString("xml/transaction/sales/SalesOrderCustomerQueryRequestMissingXactId.xml");

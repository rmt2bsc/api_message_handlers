...
import org.rmt2.api.handlers.admin.resource.subtype.ResourceSubTypeDeleteApiHandler;
...
public class ResourceSubTypeDeleteMessageHandlerTest extends BaseAuthenticationMessageHandlerTest {
     ...
     * 
     */
    public ResourceSubTypeDeleteMessageHandlerTest() {
        return;
    }
    ...
    public void testSuccess_Delete() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/subtype/ResourceSubTypeDeleteRequest.xml");
        try {
        ...
        try {
            results = handler.processMessage(ApiTransactionCodes.AUTH_RESOURCE_SUB_TYPE_DELETE, request);
        ...
        Assert.assertEquals(ResourceSubTypeMessageHandlerConst.MESSAGE_DELETE_SUCCESS, actualRepsonse.getReplyStatus()
                .getMessage());
    }
    ...
    public void testSuccess_NotFound() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/subtype/ResourceSubTypeDeleteRequest.xml");
        try {
            when(this.mockApi.deleteResourceSubType(isA(ResourceDto.class))).thenReturn(0);
        } catch (ResourceRegistryApiException e) {
            Assert.fail("Unable to setup mock stub for deleting resource type record");
        }
        MessageHandlerResults results = null;
        ...
        Assert.assertEquals(MessagingConstants.RETURN_CODE_SUCCESS, actualRepsonse.getReplyStatus().getReturnCode().intValue());
        Assert.assertEquals(MessagingConstants.RETURN_STATUS_SUCCESS, actualRepsonse.getReplyStatus().getReturnStatus());
        Assert.assertEquals(ResourceSubTypeMessageHandlerConst.MESSAGE_NOT_FOUND, actualRepsonse.getReplyStatus()
                .getMessage());
    }
    ...
    public void testError_API_Error() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/subtype/ResourceSubTypeDeleteRequest.xml");
        try {
            when(this.mockApi.deleteResourceSubType(isA(ResourceDto.class))).thenThrow(
                    new ResourceRegistryApiException(API_ERROR));
        } catch (ResourceRegistryApiException e) {
            Assert.fail("Unable to setup mock stub for deleting resource sub type record");
        }
        ...
        Assert.assertEquals(MessagingConstants.RETURN_CODE_SUCCESS, actualRepsonse.getReplyStatus().getReturnCode().intValue());
        Assert.assertEquals(MessagingConstants.RETURN_STATUS_SUCCESS, actualRepsonse.getReplyStatus().getReturnStatus());
        Assert.assertEquals(ResourceSubTypeMessageHandlerConst.MESSAGE_DELETE_ERROR, actualRepsonse.getReplyStatus()
                .getMessage());
    ...
    public void testValidation_Invalid_Transaction_Code() {
        String request = RMT2File
                .getFileContentsAsString("xml/admin/resource/subtype/ResourceSubTypeDeleteRequest_InvalidTransactionCode.xml");
    ...
    public void testValidation_Missing_Profile() {
        String request = RMT2File
                .getFileContentsAsString("xml/admin/resource/subtype/ResourceSubTypeDeleteRequest_MissingProfile.xml");
    ...
    public void testValidation_Missing_Profile_ResourceInfo_Node() {
        ...
        Assert.assertEquals(MessagingConstants.RETURN_CODE_FAILURE, actualRepsonse.getReplyStatus().getReturnCode().intValue());
        Assert.assertEquals(MessagingConstants.RETURN_STATUS_BAD_REQUEST, actualRepsonse.getReplyStatus().getReturnStatus());
        Assert.assertEquals(ResourceSubTypeMessageHandlerConst.MESSAGE_MISSING_RESOURCE_SUBTYPE_SECTION, actualRepsonse
                .getReplyStatus()
                .getMessage());
    }
    ...
    public void testValidation_Too_Many_Records() {
        String request = RMT2File
                .getFileContentsAsString("xml/admin/resource/subtype/ResourceSubTypeDeleteRequest_TooManyRecords.xml");

...
import org.rmt2.api.handlers.admin.resource.type.ResourceTypeDeleteApiHandler;
...
public class ResourceTypeDeleteMessageHandlerTest extends BaseAuthenticationMessageHandlerTest {
     ...
     * 
     */
    public ResourceTypeDeleteMessageHandlerTest() {
        return;
    }
    ...
    public void testSuccess_Create() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/type/ResourceTypeDeleteRequest.xml");
        try {
        ...
        ResourceTypeDeleteApiHandler handler = new ResourceTypeDeleteApiHandler();
        try {
            results = handler.processMessage(ApiTransactionCodes.AUTH_RESOURCE_TYPE_DELETE, request);
        ...
        Assert.assertEquals(ResourceTypeMessageHandlerConst.MESSAGE_DELETE_SUCCESS, actualRepsonse.getReplyStatus()
                .getMessage());
    }
    ...
    public void testSuccess_NotFound() {
        ...
        Assert.assertEquals(MessagingConstants.RETURN_CODE_SUCCESS, actualRepsonse.getReplyStatus().getReturnCode().intValue());
        Assert.assertEquals(MessagingConstants.RETURN_STATUS_SUCCESS, actualRepsonse.getReplyStatus().getReturnStatus());
        Assert.assertEquals(ResourceTypeMessageHandlerConst.MESSAGE_NOT_FOUND, actualRepsonse.getReplyStatus()
                .getMessage());
    }
    ...
    public void testError_API_Error() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/type/ResourceTypeDeleteRequest.xml");
        try {
            when(this.mockApi.deleteResourceType(isA(ResourceDto.class))).thenThrow(new ResourceRegistryApiException(API_ERROR));
        } catch (ResourceRegistryApiException e) {
        ...
        Assert.assertEquals(MessagingConstants.RETURN_CODE_SUCCESS, actualRepsonse.getReplyStatus().getReturnCode().intValue());
        Assert.assertEquals(MessagingConstants.RETURN_STATUS_SUCCESS, actualRepsonse.getReplyStatus().getReturnStatus());
        Assert.assertEquals(ResourceTypeMessageHandlerConst.MESSAGE_DELETE_ERROR, actualRepsonse.getReplyStatus()
                .getMessage());
    ...
    public void testValidation_Invalid_Transaction_Code() {
        String request = RMT2File
                .getFileContentsAsString("xml/admin/resource/type/ResourceTypeDeleteRequest_InvalidTransactionCode.xml");
    ...
    public void testValidation_Missing_Profile() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/type/ResourceTypeDeleteRequest_MissingProfile.xml");
    ...
    public void testValidation_Missing_Profile_ResourceInfo_Node() {
        String request = RMT2File
                .getFileContentsAsString("xml/admin/resource/type/ResourceTypeDeleteRequest_MissingResourcesInfo.xml");
    ...
    public void testValidation_Too_Many_Records() {
        String request = RMT2File.getFileContentsAsString("xml/admin/resource/type/ResourceTypeDeleteRequest_TooManyRecords.xml");

...
/**
 * Common message handler which manages users for Authentication/Security API.
 * 
 * @author roy.terrell
 *
 */
public abstract class UserApiHandler extends
        AbstractJaxbMessageHandler<AuthenticationRequest, AuthenticationResponse, List<UserType>> {
    
    private static final Logger logger = Logger.getLogger(UserApiHandler.class);
    ...
    public UserApiHandler() {
        ...
        logger.info(UserApiHandler.class.getName() + " was instantiated successfully");
    }

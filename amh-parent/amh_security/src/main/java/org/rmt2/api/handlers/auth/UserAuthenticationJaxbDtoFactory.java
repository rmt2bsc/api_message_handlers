...
public class UserAuthenticationJaxbDtoFactory extends RMT2Base {
    ...
    public static final UserDto createDtoInstance(ApplicationAccessType jaxbObj) {
        ...
        dto.setUsername(jaxbObj.getUserInfo().getPassword());
        return dto;
    }
    ...
    public static final List<UserDto> createDtoInstance(List<UserType> jaxbObj) {
        ...
        for (UserType item : jaxbObj) {
            list.add(UserAuthenticationJaxbDtoFactory.createDtoInstance(item));
        }
        return list;
    }
    ...
    public static final List<UserType> createJaxbInstance(List<UserDto> results) {
        ...
        for (UserDto item : results) {
            list.add(UserAuthenticationJaxbDtoFactory.createJaxbInstance(item));
        }
        return list;
    }
    ...
    public static final List<UserType> createJaxbInstance(List<UserDto> results, Map<Integer, List<CategoryDto>> userAppRolesMap) {
        ...
        for (UserDto item : results) {
            UserType ut = UserAuthenticationJaxbDtoFactory.createJaxbInstance(item);
            ...
            if (userAppRoles != null) {
                ...
                ut.getGrantedAppRoles().getUserAppRole().addAll(UserAuthenticationJaxbDtoFactory.createJaxbListInstance(userAppRoles));
            }
            list.add(ut);
        }
        return list;
    ...
    public static final List<String> createAppRoleCodeList(UserAppRolesType jaxbObj) {
        ...
        List<CategoryDto> list = UserAuthenticationJaxbDtoFactory.createDtoInstance(jaxbObj);
    ...
    public static final List<UserAppRoleType> createJaxbListInstance(List<CategoryDto> dtoList) {
        ...
        for (CategoryDto item : dtoList) {
            UserAppRoleType uart = UserAuthenticationJaxbDtoFactory.createJaxbInstance(item);
            list.add(uart);
        }
        return list;
    }

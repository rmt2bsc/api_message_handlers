...
public class ArtistApiHandlerConst {
    ...
    public static final String MESSAGE_UPDATE_NEW_SUCCESS = "New artist was created successfully";
    public static final String MESSAGE_UPDATE_EXISTING_SUCCESS = "Artist was updated successfully";

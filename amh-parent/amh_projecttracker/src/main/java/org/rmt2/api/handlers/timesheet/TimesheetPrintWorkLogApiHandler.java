...
/**
 * Handles and routes timesheet detailed hours work log printing related
 * messages to the ProjectTracker API.
 * 
 * @author roy.terrell
 *
 */
public class TimesheetPrintWorkLogApiHandler extends AbstractTimesheetPrintApiHandler {
    
    private static final Logger logger = Logger.getLogger(TimesheetPrintWorkLogApiHandler.class);

    /**
     * @param payload
     */
    public TimesheetPrintWorkLogApiHandler() {
        super();
        logger.info(TimesheetPrintWorkLogApiHandler.class.getName() + " was instantiated successfully");
    }
